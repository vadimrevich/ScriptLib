@echo on
rem *******************************************************
rem OpenWpwshThisAsAdmin.cmd
rem This Script Opens Windows Powershell Window at Current Folder as Administrator
rem *******************************************************
@echo off
...
rem
set CURRENTDIR=%~dp0
set EXPLOREREXE=%SystemRoot%\System32\WindowsPowerShell\v1.0\powershell.exe
...
echo Run Payload...
rem
start %EXPLOREREXE% -NoProfile -NoExit -Command Set-Location %CURRENTDIR%
